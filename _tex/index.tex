...
\hypersetup{
  pdftitle={La Palma Earthquakes and Testing},
  pdfauthor={Simon; Rowan Cockett},
...
\begin{document}
\title{La Palma Earthquakes and Testing}

\authors{Simon\affil{1}, Rowan Cockett\affil{1}}
\affiliation{1}{Curvenote, }
\correspondingauthor{Simon}{steve@curvenote.com}
...
\textsubscript{Source:
\href{https://13w13.github.io/13w13-quarto-manuscript-template/index.qmd.html}{Article
Notebook}}
...
\textsubscript{Source:
\href{https://13w13.github.io/13w13-quarto-manuscript-template/notebooks/explore-earthquakes-preview.html\#cell-fig-spatial-plot}{Explore
Earthquakes}}
